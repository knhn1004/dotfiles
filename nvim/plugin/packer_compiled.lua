...
_G.packer_plugins = {
  ...
  ["cmp-nvim-lua"] = {
    loaded = true,
    path = "/home/oliver/.local/share/nvim/site/pack/packer/start/cmp-nvim-lua",
  ...
  ["vim-sensible"] = {
    loaded = true,
    path = "/home/oliver/.local/share/nvim/site/pack/packer/start/vim-sensible",
  ...
  ["vim-tmux-navigator"] = {
    loaded = true,
    path = "/home/oliver/.local/share/nvim/site/pack/packer/start/vim-tmux-navigator",
